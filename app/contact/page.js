...
export default function Contact() {
 ...
 <span style="font-size: 12px; margin-top: 5px;"><input type="checkbox" name="agree" checked disabled> I authorise LML Homes LLP & its representatives to contact me with updates and notifications via Email / SMS /WhatsApp / Call. This will override DND/NDNC. I accept the <a href="https://www.lmlhomes.in/privacy-policy" target="_blank">privacy policy</a>.</span>
