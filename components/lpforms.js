            ...
            <Container>
                <Row>
                    ...
                    <form ref={formRef} onSubmit={handleSubmit} name="google-sheet">
                        ...
                        <input type='text' className={styles.formInput + ' pb-5'} placeholder='* Note' required value={note} onChange={(e) => setNote(e.target.value)} name='Note' />
                        <p style={{ fontSize: '11px', textAlign: 'left', width: '250px', marginTop: '10px' }}>
                            <img src='https://www.lmlhomes.in/assets/images/tick-mark.jpg' height="12" /> I authorise LML Homes LLP & its representatives to contact me with updates and notifications via Email / SMS /WhatsApp / Call. This will override DND/NDNC. I accept the <a href='https://www.lmlhomes.in/privacy-policy' target='_blank'>privacy policy</a>
                        </p>
