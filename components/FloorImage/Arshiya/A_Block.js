                    ...
                    <Col lg={6}>
                        <table className={styles.mapTable}>
                            <tbody>
                                ...
                                <tr id="a-7" className={`${highlightedArea === 'a-7' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 202</td>
                                    <td>1047 sq.ft</td>
                                    <td>2 BHK</td>
                                </tr>

                                <tr id="a-8" className={`${highlightedArea === 'a-8' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 203</td>
                                    <td>1021 sq.ft</td>
                                    <td>2 BHK</td>
                                </tr>

                                <tr id="a-9" className={`${highlightedArea === 'a-9' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 204</td>
                                    <td>1040 sq.ft</td>
                                    <td>2 BHK</td>
                                </tr>

                                <tr id="a-10" className={`${highlightedArea === 'a-10' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 205</td>
                                    <td>1043 sq.ft</td>
                                    <td>3 BHK</td>
                                </tr>

                                <tr id="a-11" className={`${highlightedArea === 'a-11' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 206</td>
                                    <td>1411 sq.ft</td>
                                    <td>3 BHK</td>
                                </tr>

                                <tr id="a-12" className={`${highlightedArea === 'a-12' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 207</td>
                                    <td>1399 sq.ft</td>
                                    <td>2 BHK</td>
                                </tr>

                                <tr id="a-13" className={`${highlightedArea === 'a-' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 301</td>
                                    <td>115 sq.ft</td>
                                    <td>2 BHK</td>
                                </tr>

                                <tr id="a-14" className={`${highlightedArea === 'a-' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 302</td>
                                    <td>1047 sq.ft</td>
                                    <td>2 BHK</td>
                                </tr>

                                <tr id="a-15" className={`${highlightedArea === 'a-' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 303</td>
                                    <td>1021 sq.ft</td>
                                    <td>2 BHK</td>
                                </tr>

                                <tr id="a-16" className={`${highlightedArea === 'a-' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 304</td>
                                    <td>1019 sq.ft</td>
                                    <td>2 BHK</td>
                                </tr>

                                <tr id="a-17" className={`${highlightedArea === 'a-' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 305</td>
                                    <td>1390 sq.ft</td>
                                    <td>3 BHK</td>
                                </tr>

                                <tr id="a-18" className={`${highlightedArea === 'a-' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 306</td>
                                    <td>1399 sq.ft</td>
                                    <td>3 BHK</td>
                                </tr>

                                <tr id="a-19" className={`${highlightedArea === 'a-' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 307</td>
                                    <td>1024 sq.ft</td>
                                    <td>2 BHK</td>
                                </tr>

                                <tr id="a-20" className={`${highlightedArea === 'a-' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 401</td>
                                    <td>1115 sq.ft</td>
                                    <td>2 BHK</td>
                                </tr>

                                <tr id="a-21" className={`${highlightedArea === 'a-' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 402</td>
                                    <td>1047 sq.ft</td>
                                    <td>2 BHK</td>
                                </tr>

                                <tr id="a-22" className={`${highlightedArea === 'a-' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 403</td>
                                    <td>1021 sq.ft</td>
                                    <td>2 BHK</td>
                                </tr>

                                <tr id="a-23" className={`${highlightedArea === 'a-' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 404</td>
                                    <td>1019 sq.ft</td>
                                    <td>2 BHK</td>
                                </tr>

                                <tr id="a-24" className={`${highlightedArea === 'a-' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 405</td>
                                    <td>1390 sq.ft</td>
                                    <td>3 BHK</td>
                                </tr>

                                <tr id="a-25" className={`${highlightedArea === 'a-' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 406</td>
                                    <td>1399 sq.ft</td>
                                    <td>3 BHK</td>
                                </tr>

                                <tr id="a-26" className={`${highlightedArea === 'a-' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 407</td>
                                    <td>1024 sq.ft</td>
                                    <td>2 BHK</td>
                                </tr>

                                <tr id="a-27" className={`${highlightedArea === 'a-' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 501</td>
                                    <td>1021 sq.ft</td>
                                    <td>2 BHK</td>
                                </tr>

                                <tr id="a-28" className={`${highlightedArea === 'a-' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 502</td>
                                    <td>1021 sq.ft</td>
                                    <td>2 BHK</td>
                                </tr>

                                <tr id="a-29" className={`${highlightedArea === 'a-' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 503</td>
                                    <td>1021 sq.ft</td>
                                    <td>2 BHK</td>
                                </tr>

                                <tr id="a-30" className={`${highlightedArea === 'a-' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 504</td>
                                    <td>1019 sq.ft</td>
                                    <td>2 BHK</td>
                                </tr>

                                <tr id="a-31" className={`${highlightedArea === 'a-' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 505</td>
                                    <td>1390 sq.ft</td>
                                    <td>3 BHK</td>
                                </tr>

                                <tr id="a-32" className={`${highlightedArea === 'a-' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 403</td>
                                    <td>1399 sq.ft</td>
                                    <td>3 BHK</td>
                                </tr>

                                <tr id="a-33" className={`${highlightedArea === 'a-' ? 'highlightedRow' : ''}`}>
                                    <td>1 - 403</td>
                                    <td>1024 sq.ft</td>
                                    <td>2 BHK</td>
                                </tr>
