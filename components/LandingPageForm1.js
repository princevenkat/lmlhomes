                ...
                <Row>
                    ...
                    <div className={styles.homeEnquiryDiv}>
                        ...
                        <p>Please fill out the form below and we
                            will get back to you as soon as possible12345.
                        </p>
                    </div>
                    <form ref={formRef} onSubmit={handleSubmit} name="google-sheet">
                        <input type='text' className={styles.formInput} placeholder='* Name 1234' required value={name} onChange={(e) => setName(e.target.value)} name='Name' />
